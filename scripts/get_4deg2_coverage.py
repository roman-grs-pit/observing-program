...
arser.add_argument("--dec0", help="ra center",default=-0.75,type=float)
parser.add_argument("--decmin", help="dec center",default=-1,type=float)

parser.add_argument("--randens", help="density of random points /deg2 to use",default=2500,type=float)

parser.add_argument("--dithra", help="dither step in the ra direction",default=0.05,type=float)
...
ndec = 5 #number of "rows"
nra = 3 #number of "columns"
